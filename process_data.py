...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--source_dir', type=str, default="", help='Path to the source dataset')
    parser.add_argument('-t', '--target_dir', type=str, default="", help='Where to save the new dataset')
...
# CUDA_VISIBLE_DEVICES=7 python process_data.py
