...
def get_experiment_dir(root_dir, args):
    # if args.pretrained is not None and 'EnDora-XL-2-256x256.pt' not in args.pretrained:
    #     root_dir += '-WOPRE'
    if args.use_compile:
